namespace VSCC.Roll20.Macros.ItemLinks
{
    ...
    public class MacroActionILCostGold : MacroActionItemLinkBase
    {
        private readonly MacroAction[] _backend = new MacroAction[1];
        public override string Name => this.Translate("Macro_ILCostGold");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_ILCostGold_FullInnerText", this.Params[0].CreateFullInnerText());

        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_ILCostGold_Text_0"));
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_ILCostGold_Text_1"));
        }
