namespace VSCC.Roll20.Macros.ItemLinks
{
    ...
    public class MacroActionILType : MacroActionItemLinkBase
    {
        private readonly MacroAction[] _backend = new MacroAction[1];
        public override string Name => this.Translate("Macro_ILType");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_ILType_FullInnerText", this.Params[0].CreateFullInnerText());

        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_ILType_Text_0"));
