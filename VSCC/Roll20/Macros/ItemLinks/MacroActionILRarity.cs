namespace VSCC.Roll20.Macros.ItemLinks
{
    ...
    public class MacroActionILRarity : MacroActionItemLinkBase
    {
        private readonly MacroAction[] _backend = new MacroAction[1];
        public override string Name => this.Translate("Macro_ILRarity");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_ILRarity_FullInnerText", this.Params[0].CreateFullInnerText());

        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_ILRarity_Text_0"));
