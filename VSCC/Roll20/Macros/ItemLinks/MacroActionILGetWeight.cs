namespace VSCC.Roll20.Macros.ItemLinks
{
    ...
    public class MacroActionILGetWeight : MacroActionItemLinkBase
    {
        private readonly MacroAction[] _backend = new MacroAction[1];
        public override string Name => this.Translate("Macro_ILGetWeight");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_ILGetWeight_FullInnerText", this.Params[0].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_ILGetWeight_Text_0"));
