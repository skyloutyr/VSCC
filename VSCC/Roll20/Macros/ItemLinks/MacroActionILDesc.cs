namespace VSCC.Roll20.Macros.ItemLinks
{
    ...
    public class MacroActionILDesc : MacroActionItemLinkBase
    {
        private readonly MacroAction[] _backend = new MacroAction[1];
        public override string Name => this.Translate("Macro_ILDesc");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_ILDesc_FullInnerText", this.Params[0].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_ILDesc_Text_0"));
        ...
        public override object Execute(Macro m, List<string> errors)
        {
            ...
            {
                return ii.Description ?? string.Empty;
            }
