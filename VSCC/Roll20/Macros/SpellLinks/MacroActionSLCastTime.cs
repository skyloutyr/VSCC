namespace VSCC.Roll20.Macros.SpellLinks
{
    ...
    public class MacroActionSLCastTime : MacroActionSpellLinkBase
    {
        private readonly MacroAction[] _backend = new MacroAction[1];
        public override string Name => this.Translate("Macro_SLCastTime_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_SLCastTime_FullInnerText", this.Params[0].CreateFullInnerText());

        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_SLCastTime_Text_0"));
        ...
        public override object Execute(Macro m, List<string> errors)
        {
            ...
            {
                return s.CastTime ?? string.Empty;
            }
