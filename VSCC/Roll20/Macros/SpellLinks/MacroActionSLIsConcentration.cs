namespace VSCC.Roll20.Macros.SpellLinks
{
    ...
    public class MacroActionSLIsConcentration : MacroActionSpellLinkBase
    {
        private readonly MacroAction[] _backend = new MacroAction[1];
        public override string Name => this.Translate("Macro_SLIsConcentration_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_SLIsConcentration_FullInnerText", this.Params[0].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_SLIsConcentration_Text_0"));
        }
        ...
        public override object Execute(Macro m, List<string> errors)
        {
            ...
            {
                return s.SpellComponents.HasFlag(SpellComponents.Concentration);
            }
