namespace VSCC.Roll20.Macros.SpellLinks
{
    ...
    public class MacroActionSLName : MacroActionSpellLinkBase
    {
        private readonly MacroAction[] _backend = new MacroAction[1];
        public override string Name => this.Translate("Macro_SLName_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_SLName_FullInnerText", this.Params[0].CreateFullInnerText());

        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_SLName_Text_0"));
