namespace VSCC.Roll20.Macros.SpellLinks
{
    ...
    public class MacroActionSLTarget : MacroActionSpellLinkBase
    {
        private readonly MacroAction[] _backend = new MacroAction[1];
        public override string Name => this.Translate("Macro_SLTarget_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_SLTarget_FullInnerText", this.Params[0].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_SLTarget_Text_0"));
