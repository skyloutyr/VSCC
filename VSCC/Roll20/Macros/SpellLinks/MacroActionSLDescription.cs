namespace VSCC.Roll20.Macros.SpellLinks
{
    ...
    public class MacroActionSLDescription : MacroActionSpellLinkBase
    {
        private readonly MacroAction[] _backend = new MacroAction[1];
        public override string Name => this.Translate("Macro_SLDescription_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_SLDescription_FullInnerText", this.Params[0].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_SLDescription_Text_0"));
