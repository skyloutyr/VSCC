namespace VSCC.Roll20.Macros.SpellLinks
{
    ...
    public class MacroActionSLIsCantrip : MacroActionSpellLinkBase
    {
        private readonly MacroAction[] _backend = new MacroAction[1];
        public override string Name => this.Translate("Macro_SLIsCantrip_Name");
        ...
        public override IEnumerable<Inline> CreateInnerText()
        {
            ...
            yield return new Run(this.Translate("Macro_SLIsCantrip_Text_0"));
        }
