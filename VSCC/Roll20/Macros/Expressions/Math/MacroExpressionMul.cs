namespace VSCC.Roll20.Macros.Expressions.Math
{
    ...
    public class MacroActionExpressionMul : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_ExpMul_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_ExpMul_FullInnerText", this.Params[0].CreateFullInnerText(), this.Params[1].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_ExpMul_Text_0"));
    ...
    public class MacroActionExpressionSimpleMul : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_ExpSMul_Name");
    ...
    public class MacroActionExpressionHPMul : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_ExpHPMul_Name");
        ...
        public override string[] CreateFormattedText() => new string[] { this.Params[0].CreateFullInnerText(), this.Params[1].CreateFullInnerText() };
        public override string CreateFullInnerText() => this.Translate("Macro_ExpHPMul_FullInnerText", this.Params[0].CreateFullInnerText(), this.Params[1].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_ExpHPMul_Text_0"));
            yield return new Hyperlink(new Run()) { Tag = 1 };
            yield return new Run(this.Translate("Macro_ExpHPMul_Text_1"));
        }
    ...
    public class MacroActionExpressionHPSimpleMul : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_ExpSHPMul_Name");
