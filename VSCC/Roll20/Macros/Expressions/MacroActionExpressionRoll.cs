namespace VSCC.Roll20.Macros.Expressions
{
    ...
    public class MacroActionExpressionRoll : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_ExpRoll_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_ExpRoll_FullInnerText", this.Params[0].CreateFullInnerText(), this.Params[1].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_ExpRoll_Text_0"));
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_ExpRoll_Text_1"));
        ...
        public override void SetDefaults()
        {
            ...
            ((MacroActionNumberConstant)this.Params[0]).SetValue(1);
            ((MacroActionNumberConstant)this.Params[1]).SetValue(20);
        }
    }
}
