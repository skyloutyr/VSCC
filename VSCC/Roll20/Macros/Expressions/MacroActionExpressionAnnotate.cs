namespace VSCC.Roll20.Macros.Expressions
{
    ...
    public class MacroActionExpressionAnnotate : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_ExpAnnotate_Name");
        ...
        public override Type[] ParamTypes => new Type[] { typeof(Expression), typeof(string) };
        ...
        public override IEnumerable<Inline> CreateInnerText()
        {
            ...
            yield return new Run(this.Translate("Macro_ExpAnnotate_Text_1"));
            yield return new Hyperlink(new Run()) { Tag = 1 };
            yield return new Run(this.Translate("Macro_ExpAnnotate_Text_2"));
        }
