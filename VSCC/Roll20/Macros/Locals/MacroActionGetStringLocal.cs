namespace VSCC.Roll20.Macros.Locals
{
    ...
    public class MacroActionGetStringLocal : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[1];

        public override string Name => this.Translate("Macro_LocalGetS_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_LocalGetS_FullInnerText", this.Params[0].CreateFullInnerText());

        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_LocalGetS_Text_0"));
        ...
        public override object Execute(Macro m, List<string> errors)
        {
            ...
            {
                return m.StringLocals[name].Item1;
            }
