namespace VSCC.Roll20.Macros.Locals
{
    ...
    public class MacroActionGetNumberLocal : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[1];

        public override string Name => this.Translate("Macro_LocalGetN_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_LocalGetN_FullInnerText", this.Params[0].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_LocalGetN_Text_0"));
        ...
        public override object Execute(Macro m, List<string> errors)
        {
            ...
            {
                return m.NumberLocals[name].Item1;
            }
