namespace VSCC.Roll20.Macros.Locals
{
    ...
    public class MacroActionSetBoolLocal : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_LocalSetB_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_LocalSetB_FullInnerText", this.Params[0].CreateFullInnerText(), this.Params[1].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_LocalSetB_Text_0"));
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_LocalSetB_Text_1"));
        ...
        public override object Execute(Macro m, List<string> errors)
        {
            ...
            {
                m.BoolLocals[name] = new Tuple<bool, bool>((bool)this.Params[1].Execute(m, errors), m.BoolLocals[name].Item2);
            }
