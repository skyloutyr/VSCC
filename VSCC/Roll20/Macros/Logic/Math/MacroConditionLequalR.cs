namespace VSCC.Roll20.Macros.Logic
{
    ...
    public class MacroConditionLequalR : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_LogicLequalR_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_LogicLequalR_FullInnerText", this.Params[0].CreateFullInnerText(), this.Params[1].CreateFullInnerText());

        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_LogicLequalR_Text_0"));
