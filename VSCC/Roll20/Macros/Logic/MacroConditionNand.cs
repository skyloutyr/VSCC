namespace VSCC.Roll20.Macros.Logic
{
    ...
    public class MacroConditionNand : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_LogicNand_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_LogicNand_FullInnerText", this.Params[0].CreateFullInnerText(), this.Params[1].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_LogicNand_Text_0"));
