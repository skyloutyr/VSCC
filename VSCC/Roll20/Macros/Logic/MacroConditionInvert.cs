namespace VSCC.Roll20.Macros.Logic
{
    ...
    public class MacroConditionInvert : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[1];

        public override string Name => this.Translate("Macro_LogicInvert_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_LogicInvert_FullInnerText", this.Params[0].CreateFullInnerText());

        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_LogicInvert_Text_0"));
        ...
        public override object Execute(Macro m, List<string> errors) => !(bool)this.Params[0].Execute(m, errors);
