namespace VSCC.Roll20.Macros.Expressions.Math
{
    ...
    public class MacroActionDiv : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_MathDiv_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_MathDiv_FullInnerText", this.Params[0].CreateFullInnerText(), this.Params[1].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_MathDiv_Text_0"));
        ...
        public override object Execute(Macro m, List<string> errors)
        {
            try
            {
                return (int)this.Params[0].Execute(m, errors) / (int)this.Params[1].Execute(m, errors);
            }
            catch (DivideByZeroException)
            {
                errors.Add(this.Translate("Macro_Error_DivideBy0"));
                return 0;
            }
        }
    ...
    public class MacroActionDivFF : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_MathDivFF_Name");
        ...
        public override object Execute(Macro m, List<string> errors)
        {
            try
            {
                return (float)this.Params[0].Execute(m, errors) / (float)this.Params[1].Execute(m, errors);
            }
            catch (DivideByZeroException)
            {
                errors.Add(this.Translate("Macro_Error_DivideBy0"));
    ...
    public class MacroActionDivFN : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_MathDivFN_Name");
        ...
        public override object Execute(Macro m, List<string> errors)
        {
            try
            {
                return (float)this.Params[0].Execute(m, errors) / (int)this.Params[1].Execute(m, errors);
            }
            catch (DivideByZeroException)
            {
                errors.Add(this.Translate("Macro_Error_DivideBy0"));
    ...
    public class MacroActionDivNF : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_MathDivNF_Name");
        ...
        public override object Execute(Macro m, List<string> errors)
        {
            try
            {
                return (int)this.Params[0].Execute(m, errors) / (float)this.Params[1].Execute(m, errors);
            }
            catch (DivideByZeroException)
            {
                errors.Add(this.Translate("Macro_Error_DivideBy0"));
