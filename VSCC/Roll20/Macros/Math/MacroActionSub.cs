namespace VSCC.Roll20.Macros.Expressions.Math
{
    ...
    public class MacroActionSub : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_MathSub_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_MathSub_FullInnerText", this.Params[0].CreateFullInnerText(), this.Params[1].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_MathSub_Text_0"));
    ...
    public class MacroActionSubFF : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_MathSubFF_Name");
    ...
    public class MacroActionSubFN : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_MathSubFN_Name");
    ...
    public class MacroActionSubNF : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_MathSubNF_Name");
