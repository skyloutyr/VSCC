namespace VSCC.Roll20.Macros.Expressions.Math
{
    ...
    public class MacroActionSum : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_MathSum_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_MathSum_FullInnerText", this.Params[0].CreateFullInnerText(), this.Params[1].CreateFullInnerText());

        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_MathSum_Text_0"));
    ...
    public class MacroActionSumFF : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_MathSumFF_Name");
    ...
    public class MacroActionSumFN : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_MathSumFN_Name");
    ...
    public class MacroActionSumNF : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[2];

        public override string Name => this.Translate("Macro_MathSumNF_Name");
