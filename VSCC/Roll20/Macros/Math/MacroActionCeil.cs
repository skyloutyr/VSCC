namespace VSCC.Roll20.Macros.Math
{
    ...
    public class MacroActionCeil : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[1];

        public override string Name => this.Translate("Macro_MathCeil_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_MathCeil_FullInnerText", this.Params[0].CreateFullInnerText());

        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_MathCeil_Text_0"));
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_MathCeil_Text_1"));
        }
