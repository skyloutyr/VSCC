namespace VSCC.Roll20.Macros.Math
{
    ...
    public class MacroActionRound : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[1];

        public override string Name => this.Translate("Macro_MathRound_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_MathRound_FullInnerText", this.Params[0].CreateFullInnerText());

        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_MathRound_Text_0"));
        ...
        public override object Execute(Macro m, List<string> errors) => (int)Math.Round((float)this.Params[0].Execute(m, errors));
