namespace VSCC.Roll20.Macros.Numbers
{
    ...
    public class MacroActionPollR20 : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[1];

        public override string Name => this.Translate("Macro_NumPollR20_Name");

        public override string Category => this.Translate("Macro_Category_Special");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_NumPollR20_FullInnerText", this.Params[0].CreateFullInnerText());

        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Run(this.Translate("Macro_NumPollR20_Text_0"));
