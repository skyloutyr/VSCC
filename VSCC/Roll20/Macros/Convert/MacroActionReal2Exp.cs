namespace VSCC.Roll20.Macros.Numbers
{
    ...
    public class MacroActionReal2Exp : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[1];

        public override string Name => this.Translate("Macro_ConvReal2Exp_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_ConvReal2Exp_FullInnerText", this.Params[0].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_ConvReal2Exp_Text_0"));
        }
