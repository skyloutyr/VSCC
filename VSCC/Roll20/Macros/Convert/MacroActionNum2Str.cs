namespace VSCC.Roll20.Macros.Numbers
{
    ...
    public class MacroActionNum2Str : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[1];

        public override string Name => this.Translate("Macro_ConvNum2Str_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_ConvNum2Str_FullInnerText", this.Params[0].CreateFullInnerText());

        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_ConvNum2Str_Text_0"));
        }
