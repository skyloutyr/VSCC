namespace VSCC.Roll20.Macros.Numbers
{
    ...
    public class MacroActionStr2Num : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[1];

        public override string Name => this.Translate("Macro_ConvStr2Num_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_ConvStr2Num_FullInnerText", this.Params[0].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_ConvStr2Num_Text_0"));
        }
        ...
        {
            if (int.TryParse(this._backend[0].Execute(m, errors).ToString(), out int i))
            {
                return i;
            }

            errors.Add(this.Translate("Macro_Error_CantParseInt"));
            return 0;
        }
