namespace VSCC.Roll20.Macros.Convert
{
    ...
    public class MacroActionReal2Num : MacroAction
    {
        private readonly MacroAction[] _backend = new MacroAction[1];

        public override string Name => this.Translate("Macro_ConvReal2Num_Name");
        ...
        public override string CreateFullInnerText() => this.Translate("Macro_ConvReal2Num_FullInnerText", this.Params[0].CreateFullInnerText());
        public override IEnumerable<Inline> CreateInnerText()
        {
            yield return new Hyperlink(new Run()) { Tag = 0 };
            yield return new Run(this.Translate("Macro_ConvReal2Num_Text_0"));
        }
